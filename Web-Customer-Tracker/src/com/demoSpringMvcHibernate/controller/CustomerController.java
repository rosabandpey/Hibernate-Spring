package com.demoSpringMvcHibernate.controller;
...
import com.demoSpringMvcHibernate.service.CustomerService;
...
public class CustomerController {
	...
	public String delete(@RequestParam("customerId") int id,Model model) {
		Customer customer=customerService.deleteCustomers(id);
		model.addAttribute("customer", customer);
		return "redirect:/customer/list";
	}
